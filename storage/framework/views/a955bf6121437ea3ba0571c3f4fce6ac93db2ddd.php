                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="appoform-wrapper">
												<?php echo Form::model($user, array('url' => 'edit-vet', 'class' => 'row', 'enctype' => 'multipart/form-data')); ?>
														...
														<div class="row">
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	...
																	<?php echo e(Form::hidden('user_type', 2)); ?>

																	<?php echo e(Form::text('user_type_text', trans('words.veterinary'), array('class' => 'form-control', 'readonly' => 'readonly'))); ?>
