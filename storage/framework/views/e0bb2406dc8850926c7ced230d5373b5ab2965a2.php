	...
	<body>
		<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" >
	  	 <tr bgcolor="#02acd8" >
			...
			<?php echo e(trans('words.mail_reg_header')); ?>
 	    ...
 	    <tr>
			...
			<?php echo e(trans('words.thank_for_reg')); ?> <?php echo e(SITE_NAME); ?>.
			<br><br>
			<?php if(isset($customtext) && $customtext != ''): ?>
			<?php echo e($customtext); ?><br><br>
			<?php endif; ?>
			<strong><?php echo e(trans('words.email')); ?>:</strong> <?php echo e($email); ?><br>
			<strong><?php echo e(trans('words.password')); ?>:</strong> <?php echo e($password); ?>
			...
			<br>
			<?php echo e(URL::to('confirm', array($id))); ?>-->
			<br><br>
