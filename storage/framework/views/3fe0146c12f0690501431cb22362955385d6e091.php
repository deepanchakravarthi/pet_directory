...
color:#fff;
	...
	<body>
		<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" >
 	    ...
 	    <tr>
    		<td height="35" valign="middle" class="content" style="padding:10px 0;"><?php echo e(trans('words.mail_hi')); ?>,<br><br>
			<?php echo e(trans('words.msg_from_contact')); ?>.<br>
			<?php echo e(trans('words.name')); ?>: <?php echo e($name); ?>

			<?php echo e(trans('words.email')); ?>: <?php echo e($email); ?>

			<?php echo e(trans('words.message')); ?>: <?php echo e($contactmessage); ?>
