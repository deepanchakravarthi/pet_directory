                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="appoform-wrapper">
												<?php echo Form::model($user, array('url' => 'edit-user', 'class' => 'row', 'enctype' => 'multipart/form-data')); ?>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
														...
														<div class="row">
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	...
																	<?php echo e(Form::hidden('user_type', 1)); ?>

																	<?php echo e(Form::text('user_type_text', trans('words.owner'), array('class' => 'form-control', 'readonly' => 'readonly'))); ?>
														...
														<?php else: ?>
														<?php echo e(Form::hidden('status', old('status'))); ?>
