<?php echo $__env->make('layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<section class="service-title" id="services">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2><?php echo e(trans('words.forget_password')); ?></h2>
				</div>
			</div>
		</div>
	</section>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="appoform-wrapper">
												...
												<?php echo Form::open(array('url' => 'forgot-password', 'class' => 'row')); ?>
													...
													<div class="col-md-6 col-sm-12">
														<div class="commentform">
															...
															<div class="row">
																<div class="col-md-12 col-sm-12">
																	<p><?php echo e(trans('words.forget_password_text')); ?></p>
															...
															<div class="row">
																...
																<div class="col-md-6 col-sm-12 center-alignment  mt-3">
																	<input onclick='location.href="login"'; type="button" value="<?php echo e(trans('words.back_login')); ?>" class="btn btn-outline-secondary btn-fullwidth width-100" />
																</div>
															</div>
														</div>
													</div>
