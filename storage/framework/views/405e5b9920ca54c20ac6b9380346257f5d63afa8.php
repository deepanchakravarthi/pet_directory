<?php echo $__env->make('layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<section class="service-title" id="services">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2><?php echo e(trans('words.edit_pet')); ?></h2>
				</div>
			</div>
		</div>
	</section>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="appoform-wrapper">
												<?php echo Form::model($pet, array('url' => 'edit-pet/'.$pet->id, 'class' => 'row', 'enctype' => 'multipart/form-data')); ?>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="commentform">
															...
															<div class="row">
																...
																<div class="col-md-6 col-sm-12">
																	<div class="card-details">
																		...
																		<?php echo e(Form::text('date_of_birth', $date, array('id' => 'date_of_birth', 'class' => 'form-control', 'placeholder' => 'dd/mm/yyyy'))); ?>
															...
															<div class="row">
																<div class="col-md-6 col-sm-12">
																	<div class="card-details">
																		...
																		<?php echo e(Form::text('chip_id', old('chip_id'), array('class' => 'form-control', 'placeholder' => '', 'readonly' => 'readonly'))); ?>
															...
															<div class="row">
																...
																<?php if($pet->is_pet_id == 0): ?>
																<?php echo e(Form::text('pet_id', old('pet_id'), array('class' => 'form-control', 'placeholder' => ''))); ?>	
																<?php else: ?>
																<?php echo e(Form::text('pet_id', old('pet_id'), array('class' => 'form-control', 'placeholder' => '', 'readonly' => 'readonly'))); ?>
															...
															<div class="row">
																...
																<div class="col-md-6 col-sm-12">
																	<label><?php echo e(trans('words.is_pet_id')); ?> <span class="required">*</span></label>
																	<label class="custom-control custom-checkbox">
																		<?php echo e(Form::checkbox('is_pet_id', 1, old('is_pet_id'), array('class' => 'custom-control-input', 'placeholder' => ''))); ?>

																		<span class="custom-control-indicator"></span>
																		<span class="custom-control-description"><?php echo e(trans('words.editable')); ?></span>
																	</label>
																</div>
															</div>
															<?php endif; ?>
