	...
	<body>
		<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" >
 	    ...
 	    <tr>
			...
			<?php echo e(trans('words.mail_response_pet_1')); ?> (<?php echo e($pet_name); ?>). <?php echo e(trans('words.mail_response_pet_2')); ?>

			<?php if($your_name != ''): ?>
			<?php echo e(trans('words.name')); ?>: <?php echo e($your_name); ?><br>
			<?php endif; ?>
			<?php if($your_phone != ''): ?>
			<?php echo e(trans('words.phone')); ?>: <?php echo e($your_phone); ?><br>
			<?php endif; ?>
			<?php if($your_email != ''): ?>
			<?php echo e(trans('words.email')); ?>: <?php echo e($your_email); ?><br>
			<?php endif; ?>
			<?php if(isset($location) && $location != ''): ?>
			<?php echo e(trans('words.location')); ?>: <?php echo e($location); ?><br>
			<?php endif; ?>
			<?php echo e(trans('words.message')); ?>: <?php echo e($your_message); ?>
