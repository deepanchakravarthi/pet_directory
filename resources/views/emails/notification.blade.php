...
color:#fff;
	...
	<body>
		<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" >
 	    ...
 	    <tr>
    		<td height="35" valign="middle" class="content" style="padding:10px 0;">{{ trans('words.mail_hi') }},<br><br>
			{{ trans('words.msg_from_contact') }}.<br>
			{{ trans('words.name') }}: {{ $name }}<br>
			{{ trans('words.email') }}: {{ $email }}<br>
			{{ trans('words.message') }}: {{ $contactmessage }}
			<br><br>
