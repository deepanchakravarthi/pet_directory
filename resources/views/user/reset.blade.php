							...
							<div class="post-desc">
								<div class="row">
									<div class="col-md-12 col-xs-12">
										...
										{!! Form::open(array('url' => 'reset-password', 'class' => 'row')) !!}
												...
												<div class="commentform">
													...
													<div class="row mt-2">
														...
														<div class="col-md-6 col-sm-12">
															...
															{{ Form::password('password_confirmation', array('class' => 'form-control', 'placeholder' => trans('words.cpassword'))) }}
														</div>
													</div>
													<div class="row">
														...
														<div class="col-md-6 col-sm-12 center-alignment mt-3">
															<input onclick='location.href="{{ SITE_PATH }}/login"'; type="button" value="{{ trans('words.back_login') }}" class="btn btn-outline-secondary btn-fullwidth width-100" />
														</div>
													</div>
												</div>
											</div>
