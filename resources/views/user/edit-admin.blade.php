                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="appoform-wrapper">
												{!! Form::model($user, array('url' => 'edit-admin', 'class' => 'row', 'enctype' => 'multipart/form-data')) !!}
														...
														<div class="row">
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	...
																	{{ Form::text('user_type_text', trans('words.admin'), array('class' => 'form-control', 'readonly' => 'readonly')) }}
																</div>
															</div>
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
