                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="appoform-wrapper">
											@if(Auth::user()->user_type == 1)
												{!! Form::model($user, array('url' => 'edit-profile', 'class' => 'row', 'enctype' => 'multipart/form-data')) !!}
											@elseif(Auth::user()->user_type == 2)
												{!! Form::model($user, array('url' => 'edit-profile-vet', 'class' => 'row', 'enctype' => 'multipart/form-data')) !!}
											@elseif(Auth::user()->user_type == 3)
												{!! Form::model($user, array('url' => 'edit-profile-authority', 'class' => 'row', 'enctype' => 'multipart/form-data')) !!}
											@endif
                                                    ...
                                                    <div class="col-md-8 col-sm-12">
															...
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	<label>{{ trans('words.user_type') }} <span class="required"></span></label>
																		...
																		{{ Form::text('user_type', $userTypes[$user->user_type], array('class' => 'form-control', 'readonly' => 'readonly')) }}
																</div>
															</div>
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	<label>{{ trans('words.salutation') }} <span class="required">*</span></label>
																	{{ Form::text('salutation', $salutationArray[$user->salutation], array('class' => 'form-control', 'readonly' => 'readonly')) }}
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	...
																	{{ Form::text('firstname', old('firstname'), array('class' => 'form-control', 'placeholder' => trans('words.firstname'), 'readonly' => 'readonly')) }}
																</div>
															</div>
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	<label>{{ trans('words.lastname') }} <span class="required">*</span></label>
																	{{ Form::text('lastname', old('lastname'), array('class' => 'form-control', 'placeholder' => trans('words.lastname'), 'readonly' => 'readonly')) }}
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	...
																	{{ Form::password('confirm_password', array('class' => 'form-control', 'placeholder' => trans('words.password'))) }}
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															...
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	<label>{{ trans('words.company') }} <span class="required"><?php if(Auth::user()->user_type != 1 && Auth::user()->user_type != 4) { echo '*'; } ?></span></label>
														...
														<div class="row">
															<div class="col-md-6 col-sm-12">
																<div class="card-details">
																	...
																	{{ Form::select('permission', $ownerPermissionArray, old('permission'), array('class' => 'form-control')) }}
																</div>
															</div>
														</div>
														@endif
