	...
	<body>
		<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" >
	  	<tr bgcolor="#02acd8" >
			...
			{{ trans('words.mail_forgot_password_header') }}
			</td>
  		</tr>
  		<tr>
    		<td align="left" valign="middle"><table width="700" border="0" cellspacing="0" cellpadding="0" align="center" class="fborder">
 	    <tr>
    		<td height="35" valign="middle" class="content" style="padding:10px 0;">{{ trans('words.mail_hi') }},<br>

			{{ trans('words.mail_forgot_password_text') }} {{ SITE_NAME }}.
			<br><br>
			{{ trans('words.mail_forgot_password_link') }}:
			<br>
			{{ URL::to('reset-password', array($token)) }}
			<br><br>
