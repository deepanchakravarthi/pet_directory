  ...
  background-color: #fefde5 !important;
	...
	<section class="service-title" id="services">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>{{ trans('words.change_subscription') }}</h2>
				</div>
			</div>
		</div>
	</section>
										...
										<div class="appoform-wrapper">
											...
											<div class="row">
												...
												<div class="col-md-7 col-sm-12">
													<p>{{ trans('words.subscription_text') }}</p>
													...
													{!! Form::open(array('url' => 'subscription-charge', 'class' => 'row', 'id' => 'payment-form')) !!}
													...
													{!! Form::open(array('url' => 'subscription-charge-iban', 'class' => 'row')) !!}
